...
SETTINGS_USERCONFIG_DEFINES.push({key: 'DarkMode', type: 'bool', name: 'Enable Dark Mode', description: 'Switches between Amazon Light Theme and AVE Dark Mode (reload required atm)'});
